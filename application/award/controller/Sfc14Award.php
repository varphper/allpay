...
class Sfc14Award extends Base
{
    ...
    {
        //获取所有未计算中奖结果的胜负彩14场有效彩票,$tickets['data']
        $tickets = (new Ticket())->getValidTickets('14场胜负');
        if (!$tickets['valid']) {
    ...
    {
        $awards = (new Sfc14Service())->dsAward($award_info, $ticket);
    ...
    {
        $awards = (new Sfc14Service())->fsAward($award_info, $ticket);
        $result = (new TicketAward())->saveAwardResult($awards, $ticket);
        return $result;
    }
